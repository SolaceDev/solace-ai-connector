...
class BrokerAdapter:
    ...
    def __init__(self, connector, command_control_service):
        ...
        if connector and hasattr(connector, "config"):
            ...
            self.topic_prefix = command_control_config.get(
                "topic_prefix", self.topic_prefix
            )

        log.info(
            "Broker Adapter initialized with namespace: %s, topic prefix: %s",
            self.namespace,
            self.topic_prefix,
        )
    ...
    def _create_request(
        self, method: str, endpoint: str, payload: Dict[str, Any], message: Message
    ) -> Dict[str, Any]:
    ...
    def publish_response(self, response: Dict[str, Any]) -> None:
        ...
        try:
            ...
            message = Message(payload=response, topic=topic, user_properties={})
    ...
    def publish_status(
        ...
        try:
            ...
            # Create a message to send
            message = Message(payload=status_message, topic=topic, user_properties={})
    ...
    def publish_metrics(
        ...
        try:
            ...
            # Create a message to send
            message = Message(payload=metrics_message, topic=topic, user_properties={})
    ...
    def publish_registry(
        self, instance_id: str, entities: Dict[str, Dict[str, Any]]
    ) -> None:
        ...
        try:
            ...
            # Create a message to send
            message = Message(payload=registry_message, topic=topic, user_properties={})
    ...
    def publish_trace(
        self, entity_id: str, trace_level: str, trace_event: Dict[str, Any]
    ) -> None:
