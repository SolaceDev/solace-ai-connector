...
class TracingSystem:
    ...
    def __init__(self, broker_adapter=None):
        ...
        log.info(
            "Tracing system initialized with default level: %s",
    ...
    def set_default_level(self, level: str):
        ...
        try:
            ...
            log.warning(
                "Invalid trace level: %s, keeping current level: %s",
                level,
                self.default_level.value,
            )
    ...
    def get_configuration(self):
        ...
        """
        entity_levels = {
            entity_id: level.value for entity_id, level in self.entity_levels.items()
        }
    ...
    def get_entity_configuration(self, entity_id: str):
        ...
        return {"entity_id": entity_id, "enabled": self.enabled, "level": level.value}
